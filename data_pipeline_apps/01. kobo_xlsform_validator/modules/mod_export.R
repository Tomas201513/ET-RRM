  ...
  shiny::tagList(
    ...
    shiny::div(
      ...
      shiny::div(
        ...
        shiny::actionButton(
          ns("btn_apply"),
          label = "Apply changes to XLS form",
          icon = shiny::icon("check"),
          class = "btn-success btn-sm",
          style = "font-size: 12px; padding: 4px 10px; flex: 1;"
        ),
    ...
    # Export issues section - full width
    shiny::div(
    ...
    # Changes detail table - full width
    shiny::div(
      class = "changes-detail",
      style = "margin-top: 15px; width: 100%; overflow-x: auto;",
    ...
    output$changes_summary <- shiny::renderUI({
      ...
      if (total_count == 0) {
        shiny::div(
          ...
          style = "display: flex; align-items: center; gap: 5px; font-size: 0.75rem; padding: 6px 10px; width: 100%;",
          
          shiny::icon("info-circle", class = "fa-xs"),
          span("No pending changes")
        )
      } else {
